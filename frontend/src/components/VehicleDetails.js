        ...
        <h3><b>Vehicle details</b></h3>
            <table class="table">
                ...
                <tr>
                    ...
                    <th>Vehicle Type</th>
                    <th>Fuel Consumption Rate (Permissible Lowest Value)</th>
                    <th>Driver ID</th>
                    <th>Driver Name</th>
                ...
                <tr key={post._id}>
                    ...
                    <td><button onClick={()=>{
                        navigate("/updateVehicle",
                        {
                            state: {
                                ...
                                driverContactNo: `${post.driverContactNo}`
                                
                            }
                        });
                    }}id="updateBtn" class="btn btn-dark" style={{fontSize:"14px"}}>Update</button></td>
                    ...
                    }} id="deleteBtn" class="btn btn-dark" style={{fontSize:"14px"}}>Delete</button></td>
